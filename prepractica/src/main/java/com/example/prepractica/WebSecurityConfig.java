...
public class WebSecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/citaMedica/confirmAppointment/**").hasRole("SECRETARY")
                .requestMatchers("/api/citaMedica/create").hasAnyRole("USER", "PATIENT", "SECRETARY")
                .requestMatchers("/api/citaMedica/findRolesByUser").hasAnyRole("USER", "PATIENT", "SECRETARY")
